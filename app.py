...
st.header('Homework_Francis Boafo')
...
scatter = alt.Chart(df).mark_point().encode(x='x',
    y='y')
...
scatter1 = alt.Chart(df,title="Modified Chart").mark_circle().encode(x='x',y='y',size='y',tooltip=['x', 'y']).configure_mark(
    opacity=0.6,
    color='Red'
)
...
- Change 1 - I added Title
- Change 2 - I colored the marks red
- Change 3 - I added tooltip 
- Change 4 - I made the marks solid circle
- Change 5 - I included opacity or transparency to the solid cirle
""")
...
- Change 1 - I changed the bar color to red
- Change 2 - I changed the opacity of the bars
""")
...
barchart1 = alt.Chart(source1).mark_bar().encode(
    x='a',
    y='b'
